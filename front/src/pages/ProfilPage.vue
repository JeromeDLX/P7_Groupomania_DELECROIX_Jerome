        ...
        <div class="row gutters-sm">  
            <div class="card col-md-12 mb-3 bg-light">
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        <h4 class="text-danger">John Doe</h4>
                        <p class="text-secondary mb-1">Full Stack Developer</p>
                        <p class="text-muted font-size-sm">Bay Area, San Francisco, CA</p>
                            <a href="/editprofil"><button class="btn btn-danger mx-1">Editer</button></a> 
                            <button class="btn btn-outline-danger mx-1">Message</button>
                    </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card col-md-8 bg-light">
                <div class="">
                    ...
                    <!--<hr>
                        <div class="row">                  
                            <div class="col-sm-12">
                                <a class="btn btn-info btn-danger" href="/editprofil">Editer</a>
                            </div>
                        </div>-->
                    </div>
                </div>
...
@media (min-width: 768px) {
    .card.col-md-4 {
        width: calc(33.333333333% - var(--gap)/2);
    }
